...
class ProductAttributeCustomValue(models.Model):
    ...
    op_sale_order_line_id = fields.Many2one('order.processing.sale.line', string="OP Sales Order Line", required=True,
                                            ondelete='cascade')


class OrderProcessingSaleLine(models.Model):
    _name = 'order.processing.sale.line'
    _description = 'Order Processing Sale'
    ...
    rfq_line_id = fields.Many2one('order.processing.rfq.line')
