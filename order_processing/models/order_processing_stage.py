...
class OrderProcessingStage(models.Model):
    """ Model for case stages. This models the main stages of a document
        management flow. Main order processing object will now use only stages, instead of state and stages.
        Stages are for example used to display the kanban view of records.
    """
    _name = "order.processing.stage"
    _description = "Order Processing Stages"
    _rec_name = 'name'
    ...
    def default_get(self, fields):
        ...
        return super(OrderProcessingStage, self.with_context(ctx)).default_get(fields)
